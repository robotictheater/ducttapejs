...
var __ = {
    ...
    ******************************************** */
    ...
    /*********************************************
        RENDER LAYOUT
    ******************************************** */
  renderLayout: function(layout, target, cb) {
    ...
    ******************************************** */
    ...
    /*********************************************
        2 WAY BIND
        Two way data binding between obj and form fields
        - obj the data object
        ...
        Object.defineProperty(obj, key, {
            ...
            set(newValue){          
              if(document.getElementById(mapping[key])){
                switch(document.getElementById(mapping[key]).tagName){
                  case "INPUT":
                    document.getElementById(mapping[key]).value=newValue;
                  break;
                  default:
                    document.getElementById(mapping[key]).innerHTML=newValue;
                  break;
                }
